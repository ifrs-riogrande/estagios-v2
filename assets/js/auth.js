...
function updateHeaderUser(session, logoutRedirect) {
  ...
  const pillAvatar = session.picture && safeUrl(session.picture)
    ? `<img src="${escapeHtml(safeUrl(session.picture))}" alt="" class="header-user-avatar" referrerpolicy="no-referrer">`
  ...
  const dropdownAvatar = session.picture && safeUrl(session.picture)
    ? `<img src="${escapeHtml(safeUrl(session.picture))}" alt="" class="header-user-dropdown-avatar" referrerpolicy="no-referrer">`
